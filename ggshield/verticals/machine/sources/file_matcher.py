...
from typing import Iterator, Optional, Pattern, Protocol, Set
...
# PEM markers that indicate a private key
_KEY_MARKERS = [
    "-----BEGIN",
...
def _looks_like_key_content(content: str) -> bool:
    ...
    return any(marker in content for marker in _KEY_MARKERS)
